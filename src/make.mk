...
CBUNIT_SOURCE_FILES += 	$(CBUNIT_SOURCE_DIRECTORY)/Application/main.cpp \
												...
												$(CBUNIT_SOURCE_DIRECTORY)/Reporters/DotTestReporter.cpp \
												$(CBUNIT_SOURCE_DIRECTORY)/Reporters/SpecTestReporter.cpp \
												$(CBUNIT_SOURCE_DIRECTORY)/Reporters/TestReporterFactory.cpp \
												$(CBUNIT_SOURCE_DIRECTORY)/OutputStreams/OutputStream.cpp \
												$(CBUNIT_SOURCE_DIRECTORY)/OutputStreams/StdCoutOutputStream.cpp \
												$(CBUNIT_SOURCE_DIRECTORY)/OutputStreams/ANSI8OutputStream.cpp \
												$(CBUNIT_SOURCE_DIRECTORY)/OutputStreams/ANSI16OutputStream.cpp \
												$(CBUNIT_SOURCE_DIRECTORY)/OutputStreams/ANSI256OutputStream.cpp \
												$(CBUNIT_SOURCE_DIRECTORY)/OutputStreams/OutputStreamFactory.cpp